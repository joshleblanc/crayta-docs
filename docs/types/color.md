...
|----------------------------------------------------------------|-------------------|------------------------------------------|------|
| Color.New(number red, number green, number blue, number alpha) | [Color](color.md) | Constructs a Color with the given values |      |
| Color.New(number red, number green, number blue)               | [Color](color.md) | Constructs a Color with the given values |      |
